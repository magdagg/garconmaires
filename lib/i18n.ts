...
export const copy = {
  ...
  en: {
    ...
    contact: {
      ...
      heroBody:
        "For press, wholesale, and collection inquiries, contact the Garçonmaires studio directly. The first drop is planned under Polish działalność nierejestrowana / unregistered activity, but seller details are still pending, so this contact page is not final commercial information.",
      email: "Email",
      base: "Base",
      name: "Name",
      subject: "Subject",
