...
export function SiteFooter({ locale }: SiteFooterProps) {
  ...
  const footerCopy =
    resolvedLocale === "pl"
      ? {
          ...
          newsletterText: "Informacje o premierze.",
          submit: "Dołącz",
          copyright: "Wszelkie prawa zastrzeżone.",
        }
      : {
          newsletter: "Newsletter",
          newsletterText: "Launch updates.",
          submit: "Join",
  ...
  return (
    <footer className="border-t border-white/10 bg-black">
      <div className="site-shell grid gap-12 px-4 py-12 md:grid-cols-[0.8fr_1.2fr] md:px-6 md:py-16">
      ...
      <div className="border-t border-white/10">
        <div className="font-label site-shell grid gap-5 px-4 py-4 text-[11px] tracking-[0.22em] text-white/35 uppercase md:grid-cols-[1fr_auto] md:items-center md:px-6">
          ...
          <p className="hidden justify-self-start md:justify-self-end md:block">
            © {new Date().getFullYear()} Garçonmaires. {footerCopy.copyright}
          </p>
        </div>
      </div>
    </footer>
