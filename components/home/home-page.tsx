      ...
      <section className="relative isolate overflow-hidden border-b border-white/10">
        ...
        <div className="site-shell relative grid min-h-[calc(100svh-72px)] items-center gap-16 px-4 py-20 md:grid-cols-[0.95fr_1.05fr] md:px-6 md:py-28">
          <div className="hero-reveal max-w-xl space-y-8">
            <p className="text-xs tracking-[0.36em] text-white/40 uppercase">
              {t.eyebrow}
            </p>
            <BrandWordmark
              priority
            ...
            />
            <h1 className="font-display text-4xl leading-[1.04] text-white sm:text-5xl lg:text-6xl">
              {t.title}
            </h1>
            <p className="max-w-lg text-sm leading-8 text-white/62 sm:text-base">
              {t.description}
            </p>
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href={withLocalePath("/about", locale)}
                className="inline-flex items-center justify-center border border-white/20 px-7 py-4 text-xs tracking-[0.28em] uppercase text-white hover:bg-white hover:text-black"
              >
                {t.secondaryCta}
              </Link>
            </div>
